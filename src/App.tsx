...
function App() {
  ...
  const services = [
    {
      title: 'Développement d\'interface web',
      description: 'Création d\'interfaces utilisateur modernes et responsives avec  HTML, CSS et JavaScript, Bootstrap',
      icon: Code
    },
    
    {
      title: 'Gestion de Bases de Données',
      description: 'Conception et optimisation de bases de données Ms Accèss',
      icon: Briefcase
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-emerald-400 dark:border-emerald-300 pl-6">
                  ...
                  <p className="text-emerald-700 dark:text-emerald-300 font-medium">1ère Année de Licence  à L'Ecole De Management et d'Innovation Technologique</p>
                  <p className="text-gray-600 dark:text-gray-300">Développement d'Application Internet Intranet</p>
                </div>
                <div className="border-l-4 border-emerald-300 dark:border-emerald-200 pl-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Serie S</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-amber-400 dark:border-amber-300 pl-6">
                  ...
                  <p className="text-amber-700 dark:text-amber-300 font-medium">Formation en Informatique</p>
                  <p className="text-gray-600 dark:text-gray-300">Fihary Soft</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-2xl p-6">
                <h4 className="text-xl font-bold text-blue-800 dark:text-blue-200 mb-4">Technologie web</h4>
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-2xl p-6">
               ...
               <div className="bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-2xl p-6">
                <h4 className="text-xl font-bold text-purple-800 dark:text-purple-200 mb-4">Outils</h4>
                <div className="flex flex-wrap gap-2">
                  {skills.outils.map((skill) => (
                    <span key={skill} className="bg-purple-600 dark:bg-purple-500 text-white px-3 py-1 rounded-full text-sm">
                      {skill}
                    </span>
                  ))}
      ...
      <AnimatedSection id="services" className="scroll-mt-24 py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Je propose des services complets de développement
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">mariejustine@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">+261 33 46 005 96</p>
                </div>
              </div>
      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">ZAITONGASOA MAHARAVO Marie Justine</h3>
            <p className="text-gray-400 dark:text-gray-500 mb-8">Développeur • Etudiante</p>
            ...
            <p className="text-gray-500 dark:text-gray-600 text-sm">
              © 2026 . ZAITONGASOA MAHARAVO Marie JustineTous droits réservés.
            </p>
          </div>
        </div>
      </footer>
